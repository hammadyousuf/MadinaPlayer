package com.kash.kashsoft.service;
...
import com.kash.kashsoft.appwidgets.AppWidgetBig;
import com.kash.kashsoft.appwidgets.AppWidgetCard;
import com.kash.kashsoft.appwidgets.AppWidgetClassic;
import com.kash.kashsoft.appwidgets.AppWidgetSmall;
import com.kash.kashsoft.glide.BlurTransformation;
import com.kash.kashsoft.glide.SongGlideRequest;
import com.kash.kashsoft.helper.ShuffleHelper;
import com.kash.kashsoft.helper.StopWatch;
...
import com.kash.kashsoft.provider.HistoryStore;
import com.kash.kashsoft.provider.MusicPlaybackQueueStore;
import com.kash.kashsoft.provider.SongPlayCountStore;
import com.kash.kashsoft.service.notification.PlayingNotification;
import com.kash.kashsoft.service.notification.PlayingNotificationImpl;
import com.kash.kashsoft.service.notification.PlayingNotificationImpl24;
import com.kash.kashsoft.service.playback.Playback;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String PHONOGRAPH_PACKAGE_NAME = "com.kas.kashsoft";
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("com.kas.kashsoft.MZ Player_MUSIC_SERVICE_CREATED"));
    }
    ...
    private void setupMediaSession() {
        ...
        mediaSession = new MediaSessionCompat(this, "MZ Player", mediaButtonReceiverComponentName, mediaButtonReceiverPendingIntent);
                    ...
                    case ACTION_PLAY_PLAYLIST:
                        ...
                        if (playlist != null) {
                            ...
                            if (!playlistSongs.isEmpty()) {
                                ...
                                Toast.makeText(getApplicationContext(), com.kash.kashsoft.R.string.playlist_is_empty, Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(getApplicationContext(), com.kash.kashsoft.R.string.playlist_is_empty, Toast.LENGTH_LONG).show();
                        }
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("com.kas.kashsoft.MZ Player_MUSIC_SERVICE_DESTROYED"));
    }
    ...
    private void playSongAtImpl(int position) {
        if (openTrackAndPrepareNextAt(position)) {
            ...
            Toast.makeText(this, getResources().getString(com.kash.kashsoft.R.string.unplayable_file), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void play() {
        synchronized (this) {
            if (requestFocus()) {
                ...
                Toast.makeText(this, getResources().getString(com.kash.kashsoft.R.string.audio_focus_denied), Toast.LENGTH_SHORT).show();
            }
        }
    }
