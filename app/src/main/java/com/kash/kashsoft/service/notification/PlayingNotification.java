...
public abstract class PlayingNotification {
    ...
    private void createNotificationChannel() {
        ...
        if (notificationChannel == null) {
            notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, service.getString(com.kash.kashsoft.R.string.playing_notification_name), NotificationManager.IMPORTANCE_LOW);
            notificationChannel.setDescription(service.getString(com.kash.kashsoft.R.string.playing_notification_description));
