...
public class NowPlayingScreenPreferenceDialog extends DialogFragment implements MaterialDialog.SingleButtonCallback, ViewPager.OnPageChangeListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        @SuppressLint("InflateParams") View view = LayoutInflater.from(getContext()).inflate(com.kash.kashsoft.R.layout.preference_dialog_now_playing_screen, null);
        ViewPager viewPager = ButterKnife.findById(view, com.kash.kashsoft.R.id.now_playing_screen_view_pager);
        ...
        InkPageIndicator pageIndicator = ButterKnife.findById(view, com.kash.kashsoft.R.id.page_indicator);
        pageIndicator.setViewPager(viewPager);
        pageIndicator.onPageSelected(viewPager.getCurrentItem());

        return new MaterialDialog.Builder(getContext())
                .title(com.kash.kashsoft.R.string.pref_title_now_playing_screen_appearance)
    ...
    private static class NowPlayingScreenAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup collection, int position) {
            ...
            ViewGroup layout = (ViewGroup) inflater.inflate(com.kash.kashsoft.R.layout.preference_now_playing_screen_item, collection, false);
            collection.addView(layout);

            ImageView image = ButterKnife.findById(layout, com.kash.kashsoft.R.id.image);
            TextView title = ButterKnife.findById(layout, com.kash.kashsoft.R.id.title);
