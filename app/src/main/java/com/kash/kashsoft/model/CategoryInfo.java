package com.kash.kashsoft.model;
...
public class CategoryInfo implements Parcelable {
    ...
    public enum Category {
        SONGS(com.kash.kashsoft.R.string.songs),
        ALBUMS(com.kash.kashsoft.R.string.albums),
        ARTISTS(com.kash.kashsoft.R.string.artists),
        GENRES(com.kash.kashsoft.R.string.genres),
        PLAYLISTS(com.kash.kashsoft.R.string.playlists);
