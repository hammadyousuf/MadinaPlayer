package com.kash.kashsoft.views;
...
public class PlayPauseDrawable extends Drawable {
    ...
    public PlayPauseDrawable(@NonNull Context context) {
        ...
        pauseBarWidth = res.getDimensionPixelSize(com.kash.kashsoft.R.dimen.pause_bar_width);
        pauseBarHeight = res.getDimensionPixelSize(com.kash.kashsoft.R.dimen.pause_bar_height);
        pauseBarDistance = res.getDimensionPixelSize(com.kash.kashsoft.R.dimen.pause_bar_distance);
    }
