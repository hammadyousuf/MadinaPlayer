...
public class BreadCrumbLayout extends HorizontalScrollView implements View.OnClickListener {
    ...
    private void init() {
        ...
        setMinimumHeight((int) getResources().getDimension(com.kash.kashsoft.R.dimen.tab_height));
    ...
    public void addCrumb(@NonNull Crumb crumb, boolean refreshLayout) {
        LinearLayout view = (LinearLayout) LayoutInflater.from(getContext()).inflate(com.kash.kashsoft.R.layout.bread_crumb, this, false);
