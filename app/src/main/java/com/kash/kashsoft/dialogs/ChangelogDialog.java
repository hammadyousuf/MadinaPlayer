...
public class ChangelogDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        try {
            customView = LayoutInflater.from(getActivity()).inflate(com.kash.kashsoft.R.layout.dialog_web_view, null);
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                .title(com.kash.kashsoft.R.string.changelog)
        ...
        final WebView webView = customView.findViewById(com.kash.kashsoft.R.id.web_view);
        try {
            // Load from MX Player(MP3)-changelog.html in the assets folder
            StringBuilder buf = new StringBuilder();
            InputStream json = getActivity().getAssets().open("MX Player(MP3)-changelog.html");
            ...
            final String backgroundColor = colorToHex(ATHUtil.resolveColor(getActivity(), com.kash.kashsoft.R.attr.md_background_color, Color.parseColor(ThemeSingleton.get().darkTheme ? "#424242" : "#ffffff")));
