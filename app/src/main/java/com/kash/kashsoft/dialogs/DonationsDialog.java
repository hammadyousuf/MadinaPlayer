...
public class DonationsDialog extends DialogFragment implements BillingProcessor.IBillingHandler {
  //  public static final String TAG = DonationsDialog.class.getSimpleName();
    ...
    private static final int DONATION_PRODUCT_IDS = com.kash.kashsoft.R.array.donation_ids;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View customView = LayoutInflater.from(getContext()).inflate(com.kash.kashsoft.R.layout.dialog_donation, null);
        ProgressBar progressBar = ButterKnife.findById(customView, com.kash.kashsoft.R.id.progress);
        MDTintHelper.setTint(progressBar, ThemeSingleton.get().positiveColor.getDefaultColor());

        return new MaterialDialog.Builder(getContext())
                .title(com.kash.kashsoft.R.string.support_development)
    ...
    public void onProductPurchased(String productId, TransactionDetails details) {
        loadSkuDetails();
        Toast.makeText(getContext(), com.kash.kashsoft.R.string.thank_you, Toast.LENGTH_SHORT).show();
    }
    ...
    private static class SkuDetailsLoadAsyncTask extends AsyncTask<Void, Void, List<SkuDetails>> {
        ...
        protected void onPreExecute() {
            ...
            customView.findViewById(com.kash.kashsoft.R.id.progress_container).setVisibility(View.VISIBLE);
            customView.findViewById(com.kash.kashsoft.R.id.list).setVisibility(View.GONE);
        }
        ...
        protected void onPostExecute(List<SkuDetails> skuDetails) {
            ...
            View customView = ((MaterialDialog) dialog.getDialog()).getCustomView();
            //noinspection ConstantConditions
            customView.findViewById(com.kash.kashsoft.R.id.progress_container).setVisibility(View.GONE);
            ListView listView = ButterKnife.findById(customView, com.kash.kashsoft.R.id.list);
    ...
    static class SkuDetailsAdapter extends ArrayAdapter<SkuDetails> {
        @LayoutRes
        private static int LAYOUT_RES_ID = com.kash.kashsoft.R.layout.item_donation_option;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            viewHolder.title.setText(skuDetails.title.replace("(MZ Player(MP3))", "").trim());
        ...
        static class ViewHolder {
            ...
            TextView text;
            @BindView(com.kash.kashsoft.R.id.price)
            TextView price;
