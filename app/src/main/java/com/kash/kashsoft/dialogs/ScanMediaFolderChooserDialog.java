...
public class ScanMediaFolderChooserDialog extends DialogFragment implements MaterialDialog.ListCallback {
    ...
    private static void scanPaths(@NonNull WeakReference<Activity> activityWeakReference, @NonNull Context applicationContext, @Nullable String[] toBeScanned) {
        ...
        if (toBeScanned == null || toBeScanned.length < 1) {
            Toast.makeText(applicationContext, com.kash.kashsoft.R.string.nothing_to_scan, Toast.LENGTH_SHORT).show();
        } else {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
            ...
            return new MaterialDialog.Builder(getActivity())
                    .title(com.kash.kashsoft.R.string.md_error_label)
                    .content(com.kash.kashsoft.R.string.md_storage_perm_error)
        ...
        MaterialDialog.Builder builder =
                new MaterialDialog.Builder(getActivity())
                        ...
                        .positiveText(com.kash.kashsoft.R.string.action_scan_directory)
