...
import com.kash.kashsoft.ui.activities.PurchaseActivity;
...
public class SleepTimerDialog extends DialogFragment {
    @BindView(com.kash.kashsoft.R.id.seek_arc)
    SeekArc seekArc;
    @BindView(com.kash.kashsoft.R.id.timer_display)
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        materialDialog = new MaterialDialog.Builder(getActivity())
                .title(getActivity().getResources().getString(com.kash.kashsoft.R.string.action_sleep_timer))
                .positiveText(com.kash.kashsoft.R.string.action_set)
                .onPositive((dialog, which) -> {
                    if (getActivity() == null) {
                        return;
                    }
                    if (!App.isProVersion()) {
                        Toast.makeText(getActivity(), getString(com.kash.kashsoft.R.string.sleep_timer_is_a_pro_feature), Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(getActivity(), getActivity().getResources().getString(com.kash.kashsoft.R.string.sleep_timer_set, minutes), Toast.LENGTH_SHORT).show();
                })
                .onNeutral((dialog, which) -> {
                    ...
                    if (previous != null) {
                        ...
                        am.cancel(previous);
                        previous.cancel();
                        Toast.makeText(getActivity(), getActivity().getResources().getString(com.kash.kashsoft.R.string.sleep_timer_canceled), Toast.LENGTH_SHORT).show();
                    }
                })
                .showListener(dialog -> {
                ...
                .customView(com.kash.kashsoft.R.layout.dialog_sleep_timer, false)
                .build();
    ...
    private class TimerUpdater extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished) {
            materialDialog.setActionButton(DialogAction.NEUTRAL, materialDialog.getContext().getString(com.kash.kashsoft.R.string.cancel_current_timer) + " (" + MusicUtil.getReadableDurationString(millisUntilFinished) + ")");
        }
