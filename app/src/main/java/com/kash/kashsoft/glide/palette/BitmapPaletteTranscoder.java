package com.kash.kashsoft.glide.palette;
...
public class BitmapPaletteTranscoder implements ResourceTranscoder<Bitmap, BitmapPaletteWrapper> {
    ...
    public Resource<BitmapPaletteWrapper> transcode(Resource<Bitmap> bitmapResource) {
        ...
        BitmapPaletteWrapper bitmapPaletteWrapper = new BitmapPaletteWrapper(bitmap, mzplayerColorUtil.generatePalette(bitmap));
        return new BitmapPaletteResource(bitmapPaletteWrapper, bitmapPool);
    }

    @Override
    public String getId() {
        return "BitmapPaletteTranscoder.com.kas.kashsoft.glide.palette";
    }
}