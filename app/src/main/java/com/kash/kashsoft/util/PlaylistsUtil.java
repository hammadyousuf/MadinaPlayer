...
import com.kash.kashsoft.helper.M3UWriter;
...
public class PlaylistsUtil {
    ...
    public static int createPlaylist(@NonNull final Context context, @Nullable final String name) {
                ...
                if (cursor == null || cursor.getCount() < 1) {
                    ...
                    if (uri != null) {
                        ...
                        Toast.makeText(context, context.getResources().getString(
                                com.kash.kashsoft.R.string.created_playlist_x, name), Toast.LENGTH_SHORT).show();
        ...
        if (id == -1) {
            Toast.makeText(context, context.getResources().getString(
                    com.kash.kashsoft.R.string.could_not_create_playlist), Toast.LENGTH_SHORT).show();
        }
        return id;
    }
    ...
    public static void addToPlaylist(@NonNull final Context context, @NonNull final List<Song> songs, final int playlistId, final boolean showToastOnFinish) {
        ...
        try {
            ...
            if (showToastOnFinish) {
                Toast.makeText(context, context.getResources().getString(
                        com.kash.kashsoft.R.string.inserted_x_songs_into_playlist_x, numInserted, getNameForPlaylist(context, playlistId)), Toast.LENGTH_SHORT).show();
            }
        } catch (SecurityException ignored) {
        }
    }
