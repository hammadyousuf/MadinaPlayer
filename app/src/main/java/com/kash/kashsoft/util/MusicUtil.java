package com.kash.kashsoft.util;
...
import com.kash.kashsoft.model.Genre;
import com.kash.kashsoft.model.Playlist;
import com.kash.kashsoft.model.Song;
import com.kash.kashsoft.model.lyrics.AbsSynchronizedLyrics;
...
public class MusicUtil {
        ...
        try {
            ...
            try {
                if (cursor != null && cursor.getCount() == 1) {
                    ...
                    final String message = context.getString(com.kash.kashsoft.R.string.x_has_been_set_as_ringtone, cursor.getString(0));
    ...
    public static String getArtistInfoString(@NonNull final Context context, @NonNull final Artist artist) {
        ...
        String albumString = albumCount == 1 ? context.getResources().getString(com.kash.kashsoft.R.string.album) : context.getResources().getString(com.kash.kashsoft.R.string.albums);
        String songString = songCount == 1 ? context.getResources().getString(com.kash.kashsoft.R.string.song) : context.getResources().getString(com.kash.kashsoft.R.string.songs);
    ...
    public static String getSongCountString(@NonNull final Context context, int songCount) {
        final String songString = songCount == 1 ? context.getResources().getString(com.kash.kashsoft.R.string.song) : context.getResources().getString(com.kash.kashsoft.R.string.songs);
        return songCount + " " + songString;
    }

    @NonNull
    public static String getAlbumCountString(@NonNull final Context context, int albumCount) {
        final String albumString = albumCount == 1 ? context.getResources().getString(com.kash.kashsoft.R.string.album) : context.getResources().getString(com.kash.kashsoft.R.string.albums);
    ...
    public static void deleteTracks(@NonNull final Context context, @NonNull final List<Song> songs) {
        ...
        try {
            ...
            Toast.makeText(context, context.getString(com.kash.kashsoft.R.string.deleted_x_songs, songs.size()), Toast.LENGTH_SHORT).show();
        } catch (SecurityException ignored) {
        }
    }

    public static boolean isFavoritePlaylist(@NonNull final Context context, @NonNull final Playlist playlist) {
        return playlist.name != null && playlist.name.equals(context.getString(com.kash.kashsoft.R.string.favorites));
    }

    public static Playlist getFavoritesPlaylist(@NonNull final Context context) {
        return PlaylistLoader.getPlaylist(context, context.getString(com.kash.kashsoft.R.string.favorites));
    }

    private static Playlist getOrCreateFavoritesPlaylist(@NonNull final Context context) {
        return PlaylistLoader.getPlaylist(context, PlaylistsUtil.createPlaylist(context, context.getString(com.kash.kashsoft.R.string.favorites)));
    }
