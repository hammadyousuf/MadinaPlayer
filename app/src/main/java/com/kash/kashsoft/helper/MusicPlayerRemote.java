...
public class MusicPlayerRemote {
    ...
    public static boolean playNext(Song song) {
        if (musicService != null) {
            ...
            Toast.makeText(musicService, musicService.getResources().getString(com.kash.kashsoft.R.string.added_title_to_playing_queue), Toast.LENGTH_SHORT).show();
            return true;
        }
        return false;
    }
    ...
    public static boolean playNext(@NonNull ArrayList<Song> songs) {
        if (musicService != null) {
            ...
            final String toast = songs.size() == 1 ? musicService.getResources().getString(com.kash.kashsoft.R.string.added_title_to_playing_queue) : musicService.getResources().getString(com.kash.kashsoft.R.string.added_x_titles_to_playing_queue, songs.size());
