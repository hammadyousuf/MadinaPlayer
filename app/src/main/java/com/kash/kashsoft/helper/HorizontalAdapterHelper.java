...
public class HorizontalAdapterHelper {
    public static final int LAYOUT_RES = com.kash.kashsoft.R.layout.item_grid_card_horizontal;
    ...
    public static void applyMarginToLayoutParams(Context context, ViewGroup.MarginLayoutParams layoutParams, int viewType) {
        int listMargin = context.getResources().getDimensionPixelSize(com.kash.kashsoft.R.dimen.default_item_margin);
