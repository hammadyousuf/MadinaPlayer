...
import com.kash.kashsoft.loader.GenreLoader;
...
public class GenreDetailActivity extends AbsSlidingMusicPanelActivity implements CabHolder, LoaderManager.LoaderCallbacks<ArrayList<Song>> {
    ...
    protected View createContentView() {
        return wrapSlidingMusicPanel(com.kash.kashsoft.R.layout.activity_genre_detail);
    }
    ...
    private void setUpRecyclerView() {
        ...
        adapter = new SongAdapter(this, new ArrayList<Song>(), com.kash.kashsoft.R.layout.item_list, false, this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.kash.kashsoft.R.menu.menu_genre_detail, menu);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case com.kash.kashsoft.R.id.action_shuffle_genre:
