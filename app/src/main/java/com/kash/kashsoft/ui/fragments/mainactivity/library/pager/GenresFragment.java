...
import com.kash.kashsoft.adapter.GenreAdapter;
...
public class GenresFragment extends AbsLibraryPagerRecyclerViewFragment<GenreAdapter, LinearLayoutManager> implements LoaderManager.LoaderCallbacks<ArrayList<Genre>> {
    ...
    protected GenreAdapter createAdapter() {
        ...
        return new GenreAdapter(getLibraryFragment().getMainActivity(), dataSet, com.kash.kashsoft.R.layout.item_list_no_image);
    }

    @Override
    protected int getEmptyMessage() {
        return com.kash.kashsoft.R.string.no_genres;
    }
