...
public class PurchaseActivity extends AbsBaseActivity implements BillingProcessor.IBillingHandler {
    ...
    Toolbar toolbar;
    @BindView(com.kash.kashsoft.R.id.restore_button)
    Button restoreButton;
    @BindView(com.kash.kashsoft.R.id.purchase_button)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.kash.kashsoft.R.layout.activity_purchase);
        ...
        getSupportActionBar().setTitle(getString(com.kash.kashsoft.R.string.buy_pro));
    ...
    public void onProductPurchased(@NonNull String productId, @Nullable TransactionDetails details) {
        Toast.makeText(this, com.kash.kashsoft.R.string.thank_you, Toast.LENGTH_SHORT).show();
        setResult(RESULT_OK);
    }
    ...
    public void onPurchaseHistoryRestored() {
        if (App.isProVersion()) {
            Toast.makeText(this, com.kash.kashsoft.R.string.restored_previous_purchase_please_restart, Toast.LENGTH_LONG).show();
            setResult(RESULT_OK);
        } else {
            Toast.makeText(this, com.kash.kashsoft.R.string.no_purchase_found, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private static class RestorePurchaseAsyncTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            if (purchaseActivity != null) {
                Toast.makeText(purchaseActivity, com.kash.kashsoft.R.string.restoring_purchase, Toast.LENGTH_SHORT).show();
            } else {
                cancel(false);
            }
        }
        ...
        protected void onPostExecute(Boolean b) {
            ...
            if (b) {
                ...
                Toast.makeText(purchaseActivity, com.kash.kashsoft.R.string.could_not_restore_purchase, Toast.LENGTH_SHORT).show();
            }
        }
    }
}
