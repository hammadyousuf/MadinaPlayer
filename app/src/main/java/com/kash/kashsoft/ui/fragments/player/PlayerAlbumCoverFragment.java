...
public class PlayerAlbumCoverFragment extends AbsMusicServiceFragment implements ViewPager.OnPageChangeListener, MusicProgressViewUpdateHelper.Callback {
    ...
    @BindView(com.kash.kashsoft.R.id.player_album_cover_viewpager)
    ViewPager viewPager;
    @BindView(com.kash.kashsoft.R.id.player_favorite_icon)
    ImageView favoriteIcon;

    @BindView(com.kash.kashsoft.R.id.player_lyrics)
    FrameLayout lyricsLayout;
    @BindView(com.kash.kashsoft.R.id.player_lyrics_line1)
    TextView lyricsLine1;
    @BindView(com.kash.kashsoft.R.id.player_lyrics_line2)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.kash.kashsoft.R.layout.fragment_player_album_cover, container, false);
