package com.kash.kashsoft.ui.fragments.player.card;
...
import com.kash.kashsoft.adapter.base.MediaEntryViewHolder;
import com.kash.kashsoft.adapter.song.PlayingQueueAdapter;
import com.kash.kashsoft.dialogs.LyricsDialog;
import com.kash.kashsoft.dialogs.SongShareDialog;
import com.kash.kashsoft.helper.MusicPlayerRemote;
import com.kash.kashsoft.helper.menu.SongMenuHelper;
import com.kash.kashsoft.model.Song;
import com.kash.kashsoft.model.lyrics.Lyrics;
import com.kash.kashsoft.ui.activities.base.AbsSlidingMusicPanelActivity;
import com.kash.kashsoft.ui.fragments.player.AbsPlayerFragment;
import com.kash.kashsoft.ui.fragments.player.PlayerAlbumCoverFragment;
import com.kash.kashsoft.util.MusicUtil;
import com.kash.kashsoft.util.Util;
import com.kash.kashsoft.util.ViewUtil;
import com.kash.kashsoft.views.WidthFitSquareLayout;
...
public class CardPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    @Nullable
    @BindView(com.kash.kashsoft.R.id.toolbar_container)
    FrameLayout toolbarContainer;
    @BindView(com.kash.kashsoft.R.id.player_toolbar)
    Toolbar toolbar;
    @BindView(com.kash.kashsoft.R.id.player_sliding_layout)
    SlidingUpPanelLayout slidingUpPanelLayout;
    @BindView(com.kash.kashsoft.R.id.player_recycler_view)
    RecyclerView recyclerView;
    @BindView(com.kash.kashsoft.R.id.playing_queue_card)
    CardView playingQueueCard;
    @BindView(com.kash.kashsoft.R.id.color_background)
    View colorBackground;
    @BindView(com.kash.kashsoft.R.id.player_queue_sub_header)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(com.kash.kashsoft.R.layout.fragment_card_player, container, false);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        slidingUpPanelLayout.setAntiDragView(view.findViewById(com.kash.kashsoft.R.id.draggable_area));
        ...
        playingQueueCard.setCardBackgroundColor(ATHUtil.resolveColor(getActivity(), com.kash.kashsoft.R.attr.cardBackgroundColor));
    }
    ...
    private void setUpSubFragments() {
        playbackControlsFragment = (CardPlayerPlaybackControlsFragment) getChildFragmentManager().findFragmentById(com.kash.kashsoft.R.id.playback_controls_fragment);
        playerAlbumCoverFragment = (PlayerAlbumCoverFragment) getChildFragmentManager().findFragmentById(com.kash.kashsoft.R.id.player_album_cover_fragment);

        playerAlbumCoverFragment.setCallbacks(this);
    }

    private void setUpPlayerToolbar() {
        toolbar.inflateMenu(com.kash.kashsoft.R.menu.menu_player);
        toolbar.setNavigationIcon(com.kash.kashsoft.R.drawable.ic_close_white_24dp);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case com.kash.kashsoft.R.id.action_show_lyrics:
                if (lyrics != null)
    ...
    private void setUpRecyclerView() {
        ...
        playingQueueAdapter = new PlayingQueueAdapter(
                ...
                com.kash.kashsoft.R.layout.item_list,
                false,
                null);
    ...
    private void updateIsFavorite() {
        ...
        updateIsFavoriteTask = new AsyncTask<Song, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean isFavorite) {
                Activity activity = getActivity();
                if (activity != null) {
                    int res = isFavorite ? com.kash.kashsoft.R.drawable.ic_favorite_white_24dp : com.kash.kashsoft.R.drawable.ic_favorite_border_white_24dp;
                    ...
                    toolbar.getMenu().findItem(com.kash.kashsoft.R.id.action_toggle_favorite)
                            .setIcon(drawable)
                            .setTitle(isFavorite ? getString(com.kash.kashsoft.R.string.action_remove_from_favorites) : getString(com.kash.kashsoft.R.string.action_add_to_favorites));
                }
            }
    ...
    private void updateLyrics() {
        ...
        updateLyricsAsyncTask = new AsyncTask<Void, Void, Lyrics>() {
            ...
            protected void onPreExecute() {
                ...
                toolbar.getMenu().removeItem(com.kash.kashsoft.R.id.action_show_lyrics);
            }
            ...
            protected void onPostExecute(Lyrics l) {
                ...
                if (lyrics == null) {
                    ...
                    if (toolbar != null && activity != null)
                        if (toolbar.getMenu().findItem(com.kash.kashsoft.R.id.action_show_lyrics) == null) {
                            int color = ToolbarContentTintHelper.toolbarContentColor(activity, Color.TRANSPARENT);
                            Drawable drawable = Util.getTintedVectorDrawable(activity, com.kash.kashsoft.R.drawable.ic_comment_text_outline_white_24dp, color);
                            toolbar.getMenu()
                                    .add(Menu.NONE, com.kash.kashsoft.R.id.action_show_lyrics, Menu.NONE, com.kash.kashsoft.R.string.action_show_lyrics)
                                    .setIcon(drawable)
    ...
    private static abstract class BaseImpl implements Impl {
        ...
        public AnimatorSet createDefaultColorChangeAnimatorSet(int newColor) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                int topMargin = fragment.getResources().getDimensionPixelSize(com.kash.kashsoft.R.dimen.status_bar_padding);
    ...
    private static class PortraitImpl extends BaseImpl {
        ...
        @Override
        public void init() {
            currentSongViewHolder = new MediaEntryViewHolder(fragment.getView().findViewById(com.kash.kashsoft.R.id.current_song));

            currentSongViewHolder.separator.setVisibility(View.VISIBLE);
            currentSongViewHolder.shortSeparator.setVisibility(View.GONE);
            currentSongViewHolder.image.setScaleType(ImageView.ScaleType.CENTER);
            currentSongViewHolder.image.setColorFilter(ATHUtil.resolveColor(fragment.getActivity(), com.kash.kashsoft.R.attr.iconColor, ThemeStore.textColorSecondary(fragment.getActivity())), PorterDuff.Mode.SRC_IN);
            currentSongViewHolder.image.setImageResource(com.kash.kashsoft.R.drawable.ic_volume_up_white_24dp);
            ...
            currentSongViewHolder.menu.setOnClickListener(new SongMenuHelper.OnClickSongMenu((AppCompatActivity) fragment.getActivity()) {
                ...
                public int getMenuRes() {
                    return com.kash.kashsoft.R.menu.menu_item_playing_queue_song;
                }

                @Override
                public boolean onMenuItemClick(MenuItem item) {
                    switch (item.getItemId()) {
                        case com.kash.kashsoft.R.id.action_remove_from_playing_queue:
        ...
        public void setUpPanelAndAlbumCoverHeight() {
            WidthFitSquareLayout albumCoverContainer = fragment.getView().findViewById(com.kash.kashsoft.R.id.album_cover_container);
            int topMargin = fragment.getResources().getDimensionPixelSize(com.kash.kashsoft.R.dimen.status_bar_padding);

            final int availablePanelHeight = fragment.slidingUpPanelLayout.getHeight() - fragment.getView().findViewById(com.kash.kashsoft.R.id.player_content).getHeight() + topMargin;
            ...
            ((AbsSlidingMusicPanelActivity) fragment.getActivity()).setAntiDragView(fragment.slidingUpPanelLayout.findViewById(com.kash.kashsoft.R.id.player_panel));
        }
    ...
    private static class LandscapeImpl extends BaseImpl {
        ...
        public void animateColorChange(int newColor) {
            ...
            animatorSet.play(ViewUtil.createBackgroundColorTransition(fragment.toolbar, fragment.lastColor, newColor))
                    .with(ViewUtil.createBackgroundColorTransition(fragment.getView().findViewById(com.kash.kashsoft.R.id.status_bar), ColorUtil.darkenColor(fragment.lastColor), ColorUtil.darkenColor(newColor)));
            animatorSet.start();
        }
    }
}