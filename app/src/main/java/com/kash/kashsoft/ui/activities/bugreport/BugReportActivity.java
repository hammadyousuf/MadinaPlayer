package com.kash.kashsoft.ui.activities.bugreport;
...
import com.kash.kashsoft.ui.activities.base.AbsThemeActivity;
import com.kash.kashsoft.ui.activities.bugreport.model.DeviceInfo;
import com.kash.kashsoft.ui.activities.bugreport.model.Report;
import com.kash.kashsoft.ui.activities.bugreport.model.github.ExtraInfo;
import com.kash.kashsoft.ui.activities.bugreport.model.github.GithubLogin;
import com.kash.kashsoft.ui.activities.bugreport.model.github.GithubTarget;
...
public class BugReportActivity extends AbsThemeActivity {
    ...
    @BindView(com.kash.kashsoft.R.id.input_layout_title)
    TextInputLayout inputLayoutTitle;
    @BindView(com.kash.kashsoft.R.id.input_title)
    TextInputEditText inputTitle;
    @BindView(com.kash.kashsoft.R.id.input_layout_description)
    TextInputLayout inputLayoutDescription;
    @BindView(com.kash.kashsoft.R.id.input_description)
    TextInputEditText inputDescription;
    @BindView(com.kash.kashsoft.R.id.air_textDeviceInfo)
    TextView textDeviceInfo;

    @BindView(com.kash.kashsoft.R.id.input_layout_username)
    TextInputLayout inputLayoutUsername;
    @BindView(com.kash.kashsoft.R.id.input_username)
    TextInputEditText inputUsername;
    @BindView(com.kash.kashsoft.R.id.input_layout_password)
    TextInputLayout inputLayoutPassword;
    @BindView(com.kash.kashsoft.R.id.input_password)
    TextInputEditText inputPassword;
    @BindView(com.kash.kashsoft.R.id.option_use_account)
    RadioButton optionUseAccount;
    @BindView(com.kash.kashsoft.R.id.option_anonymous)
    RadioButton optionManual;

    @BindView(com.kash.kashsoft.R.id.button_send)
    FloatingActionButton sendFab;

    private static final String ISSUE_TRACKER_LINK = "https://github.com/kabouzeid/mp3";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.kash.kashsoft.R.layout.activity_bug_report);
        ...
        if (TextUtils.isEmpty(getTitle()))
            setTitle(com.kash.kashsoft.R.string.report_an_issue);
            ...
            public void onClick(View v) {
                ...
                sendFab.hide(new FloatingActionButton.OnVisibilityChangedListener() {
                    ...
                    public void onHidden(FloatingActionButton fab) {
                        super.onHidden(fab);
                        sendFab.setImageResource(com.kash.kashsoft.R.drawable.ic_send_white_24dp);
                        sendFab.show();
                    }
                });
            }
        ...
        optionManual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendFab.hide(new FloatingActionButton.OnVisibilityChangedListener() {
                    ...
                    public void onHidden(FloatingActionButton fab) {
                        super.onHidden(fab);
                        sendFab.setImageResource(com.kash.kashsoft.R.drawable.ic_open_in_browser_white_24dp);
                        sendFab.show();
                    }
                });
            }
    ...
    private void copyDeviceInfoToClipBoard() {
        ...
        ClipData clip = ClipData.newPlainText(getString(com.kash.kashsoft.R.string.device_info), deviceInfo.toMarkdown());
        clipboard.setPrimaryClip(clip);

        Toast.makeText(BugReportActivity.this, com.kash.kashsoft.R.string.copied_device_info_to_clipboard, Toast.LENGTH_LONG).show();
    }
    ...
    private boolean validateInput() {
        ...
        if (optionUseAccount.isChecked()) {
            if (TextUtils.isEmpty(inputUsername.getText())) {
                setError(inputLayoutUsername, com.kash.kashsoft.R.string.bug_report_no_username);
                hasErrors = true;
            } else {
            ...
            if (TextUtils.isEmpty(inputPassword.getText())) {
                setError(inputLayoutPassword, com.kash.kashsoft.R.string.bug_report_no_password);
                hasErrors = true;
            } else {
        ...
        if (TextUtils.isEmpty(inputTitle.getText())) {
            setError(inputLayoutTitle, com.kash.kashsoft.R.string.bug_report_no_title);
            hasErrors = true;
        } else {
        ...
        if (TextUtils.isEmpty(inputDescription.getText())) {
            setError(inputLayoutDescription, com.kash.kashsoft.R.string.bug_report_no_description);
            hasErrors = true;
        } else {
    ...
    private static class ReportIssueAsyncTask extends DialogAsyncTask<Void, Void, String> {
        ...
        protected Dialog createDialog(@NonNull Context context) {
            return new MaterialDialog.Builder(context)
                    ...
                    .title(com.kash.kashsoft.R.string.bug_report_uploading)
                    .show();
        }
            ...
            switch (result) {
                ...
                case RESULT_BAD_CREDENTIALS:
                    new MaterialDialog.Builder(context)
                            .title(com.kash.kashsoft.R.string.bug_report_failed)
                            .content(com.kash.kashsoft.R.string.bug_report_failed_wrong_credentials)
                ...
                case RESULT_INVALID_TOKEN:
                    new MaterialDialog.Builder(context)
                            .title(com.kash.kashsoft.R.string.bug_report_failed)
                            .content(com.kash.kashsoft.R.string.bug_report_failed_invalid_token)
                            .positiveText(android.R.string.ok)
                            .show();
                    break;
                case RESULT_ISSUES_NOT_ENABLED:
                    new MaterialDialog.Builder(context)
                            .title(com.kash.kashsoft.R.string.bug_report_failed)
                            .content(com.kash.kashsoft.R.string.bug_report_failed_issues_not_available)
                            .positiveText(android.R.string.ok)
                            .show();
                    break;
                default:
                    new MaterialDialog.Builder(context)
                            .title(com.kash.kashsoft.R.string.bug_report_failed)
                            .content(com.kash.kashsoft.R.string.bug_report_failed_unknown)
                            .positiveText(android.R.string.ok)
