package com.kash.kashsoft.ui.activities.tageditor;
...
import com.kash.kashsoft.glide.palette.BitmapPaletteTranscoder;
...
import com.kash.kashsoft.util.ImageUtil;
import com.kash.kashsoft.util.LastFMUtil;
...
public class AlbumTagEditorActivity extends AbsTagEditorActivity implements TextWatcher {
    ...
    EditText albumTitle;
    @BindView(com.kash.kashsoft.R.id.album_artist)
    EditText albumArtist;
    @BindView(com.kash.kashsoft.R.id.genre)
    EditText genre;
    @BindView(com.kash.kashsoft.R.id.year)
    EditText year;
    ...
    protected void loadCurrentImage() {
        ...
        setImageBitmap(bitmap, mzplayerColorUtil.getColor(mzplayerColorUtil.generatePalette(bitmap), ATHUtil.resolveColor(this, com.kash.kashsoft.R.attr.defaultFooterColor)));
    ...
    protected void getImageFromLastFM() {
        ...
        if (albumArtistNameStr.trim().equals("") || albumTitleStr.trim().equals("")) {
            Toast.makeText(this, getResources().getString(com.kash.kashsoft.R.string.album_or_artist_empty), Toast.LENGTH_SHORT).show();
            return;
        }
        lastFMRestClient.getApiService().getAlbumInfo(albumTitleStr, albumArtistNameStr, null).enqueue(new Callback<LastFmAlbum>() {
                ...
                if (lastFmAlbum.getAlbum() != null) {
                    ...
                    if (!TextUtils.isEmpty(url) && url.trim().length() > 0) {
                        Glide.with(AlbumTagEditorActivity.this)
                                ...
                                .error(com.kash.kashsoft.R.drawable.default_album_art)
                                .into(new SimpleTarget<BitmapPaletteWrapper>() {
                                    ...
                                    public void onResourceReady(BitmapPaletteWrapper resource, GlideAnimation<? super BitmapPaletteWrapper> glideAnimation) {
                                        ...
                                        setImageBitmap(albumArtBitmap, mzplayerColorUtil.getColor(resource.getPalette(), ATHUtil.resolveColor(AlbumTagEditorActivity.this, com.kash.kashsoft.R.attr.defaultFooterColor)));
                                        deleteAlbumArt = false;
                                        dataChanged();
                                        setResult(RESULT_OK);
                                    }
            ...
            private void toastLoadingFailed() {
                Toast.makeText(AlbumTagEditorActivity.this,
                        com.kash.kashsoft.R.string.could_not_download_album_cover, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void deleteImage() {
        setImageBitmap(BitmapFactory.decodeResource(getResources(), com.kash.kashsoft.R.drawable.default_album_art), ATHUtil.resolveColor(this, com.kash.kashsoft.R.attr.defaultFooterColor));
        deleteAlbumArt = true;
        dataChanged();
    }
    ...
    protected int getContentViewLayout() {
        return com.kash.kashsoft.R.layout.activity_album_tag_editor;
    }
    ...
    protected void loadImageFromFile(@NonNull final Uri selectedFileUri) {
        Glide.with(AlbumTagEditorActivity.this)
                ...
                .into(new SimpleTarget<BitmapPaletteWrapper>() {
                    ...
                    @Override
                    public void onResourceReady(BitmapPaletteWrapper resource, GlideAnimation<? super BitmapPaletteWrapper> glideAnimation) {
                        mzplayerColorUtil.getColor(resource.getPalette(), Color.TRANSPARENT);
                        albumArtBitmap = ImageUtil.resizeBitmap(resource.getBitmap(), 2048);
                        setImageBitmap(albumArtBitmap, mzplayerColorUtil.getColor(resource.getPalette(), ATHUtil.resolveColor(AlbumTagEditorActivity.this, com.kash.kashsoft.R.attr.defaultFooterColor)));
                        deleteAlbumArt = false;
                        dataChanged();
