...
import com.kash.kashsoft.adapter.album.HorizontalAlbumAdapter;
import com.kash.kashsoft.adapter.song.ArtistSongAdapter;
import com.kash.kashsoft.dialogs.AddToPlaylistDialog;
import com.kash.kashsoft.dialogs.SleepTimerDialog;
import com.kash.kashsoft.glide.ArtistGlideRequest;
...
public class ArtistDetailActivity extends AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Artist> {
    ...
    @BindView(com.kash.kashsoft.R.id.album_count_icon)
    ...
    @BindView(com.kash.kashsoft.R.id.album_count_text)
    ...
    protected View createContentView() {
        return wrapSlidingMusicPanel(com.kash.kashsoft.R.layout.activity_artist_detail);
    }
    ...
    private void initViews() {
        songListHeader = LayoutInflater.from(this).inflate(com.kash.kashsoft.R.layout.artist_detail_header, songListView, false);
        albumRecyclerView = ButterKnife.findById(songListHeader, com.kash.kashsoft.R.id.recycler_view);
    }
                    ...
                    public void onResponse(@NonNull Call<LastFmArtist> call, @NonNull Response<LastFmArtist> response) {
                        ...
                        if (!Util.isAllowedToDownloadMetadata(ArtistDetailActivity.this)) {
                            if (biography != null) {
                                ...
                                Toast.makeText(ArtistDetailActivity.this, getResources().getString(com.kash.kashsoft.R.string.biography_unavailable), Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
    ...
    private void loadArtistImage() {
        ArtistGlideRequest.Builder.from(Glide.with(this), artist)
                ...
                .dontAnimate()
                .into(new mzColoredTarget(artistImage) {
                    @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.kash.kashsoft.R.menu.menu_artist_detail, menu);
        menu.findItem(com.kash.kashsoft.R.id.action_colored_footers).setChecked(usePalette);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case com.kash.kashsoft.R.id.action_equalizer:
                ...
                return true;
            case com.kash.kashsoft.R.id.action_shuffle_artist:
            ...
            case android.R.id.home:
                super.onBackPressed();
                return true;
            case com.kash.kashsoft.R.id.action_biography:
                ...
                return true;
            case com.kash.kashsoft.R.id.action_set_artist_image:
                Intent intent = new Intent(Intent.ACTION_GET_CONTENT);
                intent.setType("image/*");
                startActivityForResult(Intent.createChooser(intent, getString(com.kash.kashsoft.R.string.pick_from_local_storage)), REQUEST_CODE_SELECT_IMAGE);
                return true;
            case com.kash.kashsoft.R.id.action_reset_artist_image:
                Toast.makeText(ArtistDetailActivity.this, getResources().getString(com.kash.kashsoft.R.string.updating), Toast.LENGTH_SHORT).show();
                CustomArtistImageUtil.getInstance(ArtistDetailActivity.this).resetCustomArtistImage(artist);
                forceDownload = true;
                return true;
            case com.kash.kashsoft.R.id.action_colored_footers:
