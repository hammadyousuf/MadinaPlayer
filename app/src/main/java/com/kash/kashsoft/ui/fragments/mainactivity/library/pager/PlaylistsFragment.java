...
import com.kash.kashsoft.adapter.PlaylistAdapter;
...
import com.kash.kashsoft.model.smartplaylist.HistoryPlaylist;
...
public class PlaylistsFragment extends AbsLibraryPagerRecyclerViewFragment<PlaylistAdapter, LinearLayoutManager> implements LoaderManager.LoaderCallbacks<ArrayList<Playlist>> {
    ...
    protected PlaylistAdapter createAdapter() {
        ...
        return new PlaylistAdapter(getLibraryFragment().getMainActivity(), dataSet, com.kash.kashsoft.R.layout.item_list_single_row, getLibraryFragment());
    }

    @Override
    protected int getEmptyMessage() {
        return com.kash.kashsoft.R.string.no_playlists;
    }
