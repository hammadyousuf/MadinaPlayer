...
public abstract class AbsBaseActivity extends AbsThemeActivity {
    ...
    private String getPermissionDeniedMessage() {
        return permissionDeniedMessage == null ? getString(com.kash.kashsoft.R.string.permissions_denied) : permissionDeniedMessage;
    }
                ...
                if (grantResult != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(AbsBaseActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                        ...
                        Snackbar.make(getSnackBarContainer(), getPermissionDeniedMessage(),
                                ...
                                .setAction(com.kash.kashsoft.R.string.action_grant, view -> requestPermissions())
                        ...
                        Snackbar.make(getSnackBarContainer(), getPermissionDeniedMessage(),
                                Snackbar.LENGTH_INDEFINITE)
                                .setAction(com.kash.kashsoft.R.string.action_settings, view -> {
