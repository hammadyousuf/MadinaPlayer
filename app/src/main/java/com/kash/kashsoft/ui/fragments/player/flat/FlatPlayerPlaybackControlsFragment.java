...
import com.kash.kashsoft.misc.SimpleOnSeekbarChangeListener;
...
public class FlatPlayerPlaybackControlsFragment extends AbsMusicServiceFragment implements MusicProgressViewUpdateHelper.Callback {
    ...
    @BindView(com.kash.kashsoft.R.id.player_play_pause__button)
    ImageButton playPauseButton;
    @BindView(com.kash.kashsoft.R.id.player_prev_button)
    ImageButton prevButton;
    @BindView(com.kash.kashsoft.R.id.player_next_button)
    ImageButton nextButton;
    @BindView(com.kash.kashsoft.R.id.player_repeat_button)
    ImageButton repeatButton;
    @BindView(com.kash.kashsoft.R.id.player_shuffle_button)
    ImageButton shuffleButton;

    @BindView(com.kash.kashsoft.R.id.player_progress_slider)
    SeekBar progressSlider;
    @BindView(com.kash.kashsoft.R.id.player_song_total_time)
    TextView songTotalTime;
    @BindView(com.kash.kashsoft.R.id.player_song_current_progress)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.kash.kashsoft.R.layout.fragment_flat_player_playback_controls, container, false);
    }
    ...
    private void updateRepeatState() {
        switch (MusicPlayerRemote.getRepeatMode()) {
            case MusicService.REPEAT_MODE_NONE:
                repeatButton.setImageResource(com.kash.kashsoft.R.drawable.ic_repeat_white_24dp);
            ...
            case MusicService.REPEAT_MODE_THIS:
                repeatButton.setImageResource(com.kash.kashsoft.R.drawable.ic_repeat_one_white_24dp);
                repeatButton.setColorFilter(lastPlaybackControlsColor, PorterDuff.Mode.SRC_IN);
                break;
        }
    }
