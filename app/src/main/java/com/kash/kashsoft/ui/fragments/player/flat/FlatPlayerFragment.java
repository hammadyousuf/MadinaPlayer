package com.kash.kashsoft.ui.fragments.player.flat;
...
public class FlatPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    @BindView(com.kash.kashsoft.R.id.player_status_bar)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(com.kash.kashsoft.R.layout.fragment_flat_player, container, false);
    ...
    private void setUpSubFragments() {
        playbackControlsFragment = (FlatPlayerPlaybackControlsFragment) getChildFragmentManager().findFragmentById(com.kash.kashsoft.R.id.playback_controls_fragment);
    ...
    private static class PortraitImpl extends BaseImpl {
        ...
        public void setUpPanelAndAlbumCoverHeight() {
            ...
            final int availablePanelHeight = fragment.slidingUpPanelLayout.getHeight() - fragment.getView().findViewById(com.kash.kashsoft.R.id.player_content).getHeight();
            final int minPanelHeight = (int) ViewUtil.convertDpToPixel(8 + 72 + 24, fragment.getResources()) + fragment.getResources().getDimensionPixelSize(com.kash.kashsoft.R.dimen.progress_container_height) + fragment.getResources().getDimensionPixelSize(com.kash.kashsoft.R.dimen.media_controller_container_height);
    ...
    private static class LandscapeImpl extends BaseImpl {
        ...
        @Override
        public void setUpPanelAndAlbumCoverHeight() {
            ((AbsSlidingMusicPanelActivity) fragment.getActivity()).setAntiDragView(fragment.getView().findViewById(com.kash.kashsoft.R.id.player_panel));
        }
