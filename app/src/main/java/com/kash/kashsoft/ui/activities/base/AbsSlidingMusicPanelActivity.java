package com.kash.kashsoft.ui.activities.base;
...
import com.kash.kashsoft.ui.fragments.player.MiniPlayerFragment;
import com.kash.kashsoft.ui.fragments.player.NowPlayingScreen;
import com.kash.kashsoft.ui.fragments.player.card.CardPlayerFragment;
import com.kash.kashsoft.ui.fragments.player.flat.FlatPlayerFragment;
...
public abstract class AbsSlidingMusicPanelActivity extends AbsMusicServiceActivity implements SlidingUpPanelLayout.PanelSlideListener, CardPlayerFragment.Callbacks {
    ...
    @BindView(com.kash.kashsoft.R.id.sliding_layout)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(com.kash.kashsoft.R.id.player_fragment_container, fragment).commit();
        getSupportFragmentManager().executePendingTransactions();

        playerFragment = (AbsPlayerFragment) getSupportFragmentManager().findFragmentById(com.kash.kashsoft.R.id.player_fragment_container);
        miniPlayerFragment = (MiniPlayerFragment) getSupportFragmentManager().findFragmentById(com.kash.kashsoft.R.id.mini_player_fragment);
    ...
    public void hideBottomBar(final boolean hide) {
        if (hide) {
            ...
            slidingUpPanelLayout.setPanelHeight(getResources().getDimensionPixelSize(com.kash.kashsoft.R.dimen.mini_player_height));
        }
    }

    protected View wrapSlidingMusicPanel(@LayoutRes int resId) {
        @SuppressLint("InflateParams")
        View slidingMusicPanelLayout = getLayoutInflater().inflate(com.kash.kashsoft.R.layout.sliding_music_panel_layout, null);
        ViewGroup contentContainer = ButterKnife.findById(slidingMusicPanelLayout, com.kash.kashsoft.R.id.content_container);
    ...
    protected View getSnackBarContainer() {
        return findViewById(com.kash.kashsoft.R.id.content_container);
    }
