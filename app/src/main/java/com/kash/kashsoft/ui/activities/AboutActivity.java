...
import com.kash.kashsoft.R;
import com.kash.kashsoft.dialogs.ChangelogDialog;
import com.kash.kashsoft.dialogs.DonationsDialog;
import com.kash.kashsoft.ui.activities.base.AbsBaseActivity;
import com.kash.kashsoft.ui.activities.bugreport.BugReportActivity;
...
public class AboutActivity extends AbsBaseActivity implements View.OnClickListener {
    ...
    private static String ALEKSANDAR_TESIC_GOOGLE_PLUS = "https://google.com/+aleksandarteÅ¡iÄ‡";
    ...
    public void onClick(View v) {
        if (v == changelog) {
            ...
            intent.setData(Uri.parse("mailto:kashsoft126@gmail.com"));
            intent.putExtra(Intent.EXTRA_EMAIL, "kashsoft126@gmail.com");
            intent.putExtra(Intent.EXTRA_SUBJECT, "MX Player (MP3)");
