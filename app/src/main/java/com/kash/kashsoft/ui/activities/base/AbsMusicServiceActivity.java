...
import com.kash.kashsoft.interfaces.MusicServiceEventListener;
...
public abstract class AbsMusicServiceActivity extends AbsBaseActivity implements MusicServiceEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setPermissionDeniedMessage(getString(com.kash.kashsoft.R.string.permission_external_storage_denied));
    }
