...
import com.kash.kashsoft.adapter.song.OrderablePlaylistSongAdapter;
import com.kash.kashsoft.adapter.song.PlaylistSongAdapter;
import com.kash.kashsoft.adapter.song.SongAdapter;
...
public class PlaylistDetailActivity extends AbsSlidingMusicPanelActivity implements CabHolder, LoaderManager.LoaderCallbacks<ArrayList<Song>> {
    ...
    protected View createContentView() {
        return wrapSlidingMusicPanel(com.kash.kashsoft.R.layout.activity_playlist_detail);
    }
    ...
    private void setUpRecyclerView() {
        ...
        if (playlist instanceof AbsCustomPlaylist) {
            adapter = new PlaylistSongAdapter(this, new ArrayList<Song>(), com.kash.kashsoft.R.layout.item_list, false, this);
            recyclerView.setAdapter(adapter);
        } else {
            recyclerViewDragDropManager = new RecyclerViewDragDropManager();
            final GeneralItemAnimator animator = new RefactoredDefaultItemAnimator();
            adapter = new OrderablePlaylistSongAdapter(this, new ArrayList<PlaylistSong>(), com.kash.kashsoft.R.layout.item_list, false, this, (fromPosition, toPosition) -> {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(playlist instanceof AbsCustomPlaylist ? com.kash.kashsoft.R.menu.menu_smart_playlist_detail : com.kash.kashsoft.R.menu.menu_playlist_detail, menu);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case com.kash.kashsoft.R.id.action_shuffle_playlist:
    ...
    public MaterialCab openCab(final int menu, final MaterialCab.Callback callback) {
        ...
        cab = new MaterialCab(this, com.kash.kashsoft.R.id.cab_stub)
                ...
                .setBackgroundColor(mzplayerColorUtil.shiftBackgroundColorForLightText(ThemeStore.primaryColor(this)))
                .start(callback);
        return cab;
    }
