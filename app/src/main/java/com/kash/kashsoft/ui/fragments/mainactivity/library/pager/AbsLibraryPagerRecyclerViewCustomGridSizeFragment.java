package com.kash.kashsoft.ui.fragments.mainactivity.library.pager;
...
public abstract class AbsLibraryPagerRecyclerViewCustomGridSizeFragment<A extends RecyclerView.Adapter, LM extends RecyclerView.LayoutManager> extends AbsLibraryPagerRecyclerViewFragment<A, LM> {
    ...
    public int getMaxGridSize() {
        if (isLandscape()) {
            return getResources().getInteger(com.kash.kashsoft.R.integer.max_columns_land);
        } else {
            return getResources().getInteger(com.kash.kashsoft.R.integer.max_columns);
        }
    }
    ...
    public boolean canUsePalette() {
        return getItemLayoutRes() == com.kash.kashsoft.R.layout.item_grid;
    }
    ...
    protected int getItemLayoutRes() {
        if (getGridSize() > getMaxGridSizeForList()) {
            return com.kash.kashsoft.R.layout.item_grid;
        }
        return com.kash.kashsoft.R.layout.item_list;
    }
    ...
    protected void applyRecyclerViewPaddingForLayoutRes(@NonNull RecyclerView recyclerView, @LayoutRes int res) {
        int padding;
        if (res == com.kash.kashsoft.R.layout.item_grid) {
    ...
    protected int getMaxGridSizeForList() {
        if (isLandscape()) {
            return getActivity().getResources().getInteger(com.kash.kashsoft.R.integer.default_list_columns_land);
        }
        return getActivity().getResources().getInteger(com.kash.kashsoft.R.integer.default_list_columns);
    }
