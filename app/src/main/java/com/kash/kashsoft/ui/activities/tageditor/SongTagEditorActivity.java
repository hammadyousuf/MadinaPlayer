...
public class SongTagEditorActivity extends AbsTagEditorActivity implements TextWatcher {
    ...
    @BindView(com.kash.kashsoft.R.id.title1)
    EditText songTitle;
    @BindView(com.kash.kashsoft.R.id.title2)
    EditText albumTitle;
    @BindView(com.kash.kashsoft.R.id.artist)
    EditText artist;
    ...
    @BindView(com.kash.kashsoft.R.id.lyrics)
    EditText lyrics;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(com.kash.kashsoft.R.string.action_tag_editor);
    }
    ...
    protected int getContentViewLayout() {
        return com.kash.kashsoft.R.layout.activity_song_tag_editor;
    }
