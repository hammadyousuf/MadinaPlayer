...
public final class AppShortcutIconGenerator {
    ...
    private static IconCompat generateDefaultThemedIcon(Context context, int iconId) {
        ...
        return generateThemedIcon(context, iconId,
                context.getColor(com.kash.kashsoft.R.color.app_shortcut_default_foreground),
                context.getColor(com.kash.kashsoft.R.color.app_shortcut_default_background)
        );
    }
    ...
    private static IconCompat generateThemedIcon(Context context, int iconId, int foregroundColor, int backgroundColor) {
        ...
        Drawable backgroundDrawable = Util.getTintedVectorDrawable(context, com.kash.kashsoft.R.drawable.ic_app_shortcut_background, backgroundColor);
