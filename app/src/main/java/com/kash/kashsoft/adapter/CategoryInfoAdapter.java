...
import com.kash.kashsoft.util.SwipeAndDragHelper;
...
public class CategoryInfoAdapter extends RecyclerView.Adapter<CategoryInfoAdapter.ViewHolder> implements SwipeAndDragHelper.ActionCompletionContract {
    ...
    public CategoryInfoAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(com.kash.kashsoft.R.layout.preference_dialog_library_categories_listitem, parent, false);
    ...
    public void onBindViewHolder(CategoryInfoAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            if (!(categoryInfo.visible && isLastCheckedCategory(categoryInfo))) {
                ...
                Toast.makeText(holder.itemView.getContext(), com.kash.kashsoft.R.string.you_have_to_select_at_least_one_category, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            checkBox = view.findViewById(com.kash.kashsoft.R.id.checkbox);
            title = view.findViewById(com.kash.kashsoft.R.id.title);
            dragView = view.findViewById(com.kash.kashsoft.R.id.drag_view);
        }
    }
}
