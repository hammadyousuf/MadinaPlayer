    ...
    public void onBindViewHolder(@NonNull final SongAdapter.ViewHolder holder, int position) {
        if (holder.getItemViewType() == OFFSET_ITEM) {
            ...
            if (holder.title != null) {
                holder.title.setText(activity.getResources().getString(com.kash.kashsoft.R.string.action_shuffle_all).toUpperCase());
            ...
            if (holder.image != null) {
                ...
                holder.image.setImageResource(com.kash.kashsoft.R.drawable.ic_shuffle_white_24dp);
            }
