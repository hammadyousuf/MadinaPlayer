...
public class SongAdapter extends AbsMultiSelectAdapter<SongAdapter.ViewHolder,
        Song> implements MaterialCab.Callback, FastScrollRecyclerView.SectionedAdapter {
    ...
    public SongAdapter(AppCompatActivity activity, ArrayList<Song>
            dataSet, @LayoutRes int itemLayoutRes, boolean usePalette, @Nullable CabHolder cabHolder, boolean showSectionName) {
        super(activity, cabHolder, com.kash.kashsoft.R.menu.menu_media_selection);
    ...
    protected void loadAlbumCover(Song song, final ViewHolder holder) {
        ...
        SongGlideRequest.Builder.from(Glide.with(activity), song)
                ...
                .into(new mzColoredTarget(holder.image) {
                    @Override
                ...
                switch (item.getItemId()) {
                    case com.kash.kashsoft.R.id.action_go_to_album:
                        Pair[] albumPairs = new Pair[]{
                                Pair.create(image, activity.getResources().getString(com.kash.kashsoft.R.string.transition_album_art))
                        };
