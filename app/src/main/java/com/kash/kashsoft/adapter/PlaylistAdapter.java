package com.kash.kashsoft.adapter;
...
import com.kash.kashsoft.adapter.base.AbsMultiSelectAdapter;
import com.kash.kashsoft.adapter.base.MediaEntryViewHolder;
import com.kash.kashsoft.dialogs.ClearSmartPlaylistDialog;
import com.kash.kashsoft.dialogs.DeletePlaylistDialog;
import com.kash.kashsoft.helper.menu.PlaylistMenuHelper;
...
import com.kash.kashsoft.model.smartplaylist.LastAddedPlaylist;
...
public class PlaylistAdapter extends AbsMultiSelectAdapter<PlaylistAdapter.ViewHolder, Playlist> {
    ...
    public PlaylistAdapter(AppCompatActivity activity, ArrayList<Playlist> dataSet, @LayoutRes int itemLayoutRes, @Nullable CabHolder cabHolder) {
        super(activity, cabHolder, com.kash.kashsoft.R.menu.menu_playlists_selection);
    ...
    private int getIconRes(Playlist playlist) {
        ...
        return MusicUtil.isFavoritePlaylist(activity, playlist) ? com.kash.kashsoft.R.drawable.ic_favorite_white_24dp : com.kash.kashsoft.R.drawable.ic_queue_music_white_24dp;
    }
    ...
    public class ViewHolder extends MediaEntryViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, int itemViewType) {
            ...
            if (itemViewType == SMART_PLAYLIST) {
                ...
                itemView.setBackgroundColor(ATHUtil.resolveColor(activity, com.kash.kashsoft.R.attr.cardBackgroundColor));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    itemView.setElevation(activity.getResources().getDimensionPixelSize(com.kash.kashsoft.R.dimen.card_elevation));
                }
            }

            if (image != null) {
                int iconPadding = activity.getResources().getDimensionPixelSize(com.kash.kashsoft.R.dimen.list_item_image_icon_padding);
                image.setPadding(iconPadding, iconPadding, iconPadding, iconPadding);
                image.setColorFilter(ATHUtil.resolveColor(activity, com.kash.kashsoft.R.attr.iconColor), PorterDuff.Mode.SRC_IN);
            }
            ...
            if (menu != null) {
                menu.setOnClickListener(view -> {
                    ...
                    popupMenu.inflate(getItemViewType() == SMART_PLAYLIST ? com.kash.kashsoft.R.menu.menu_item_smart_playlist : com.kash.kashsoft.R.menu.menu_item_playlist);
                    if (playlist instanceof LastAddedPlaylist) {
                        popupMenu.getMenu().findItem(com.kash.kashsoft.R.id.action_clear_playlist).setVisible(false);
                    }
                    popupMenu.setOnMenuItemClickListener(item -> {
                        if (item.getItemId() == com.kash.kashsoft.R.id.action_clear_playlist) {
                            if (playlist instanceof AbsSmartPlaylist) {
